...
class VisitorTracker {
    ...
    private static function getPageTitle(): ?string {
        ...
        $titles = [
            ...
            '/home'                => 'Home (EN)',
            '/marketplace-central' => 'Marketplace Central',
            '/marche-central'      => 'Marketplace Central (FR)',
            '/acheteur-central'    => 'Buyer Central (FR)',
            '/vendeur-central'     => 'Seller Central (FR)',
            '/fournisseur-central' => 'Supplier Central (FR)',
            '/livreur-central'     => 'Driver Central (FR)',
            '/entreprise-centrale' => 'Distribution (FR)',
            '/about'             => 'About',
            '/contact'           => 'Contact',
            '/faq'               => 'FAQ',
            '/shop'              => 'Shop',
