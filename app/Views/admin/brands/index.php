            ...
            <tr>
              ...
              <td class="text-right">
                <div class="action-buttons">
                  ...
                  <form method="POST" action="<?= url('admin/brands/delete') ?>" style="display: inline;" onsubmit="return confirm(<?= htmlspecialchars(json_encode($t['confirm_delete'] ?? 'Are you sure?'), ENT_QUOTES) ?>)">
                    <?= csrfField() ?>
