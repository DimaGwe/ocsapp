<?php
/**
 * OCS Admin Fleet Management - Add Vehicle
 * File: app/Views/admin/delivery/vehicles/create.php
 */
...
<div class="page-header">
    <div>
        <h1 class="page-title">
            <i class="fa-solid fa-plus-circle" style="color: #00b207;"></i>
            <?= $t['add_vehicle'] ?>
        </h1>
    </div>
...
<div class="card">
    ...
    <form method="POST" action="<?= url('/admin/delivery/vehicles/store') ?>">
        <?= csrfField() ?>
        ...
        <div class="form-row single">
            <div class="form-group">
                ...
                <select name="vehicle_type" class="form-control" required>
                    ...
                    <option value="e-bike"><?= $t['e_bike'] ?> ⚡</option>
                    <option value="scooter"><?= $t['scooter'] ?> 🛵</option>
                    <option value="motorcycle"><?= $t['motorcycle'] ?> 🏍️</option>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="make" class="form-control" placeholder="<?= $t['make_placeholder'] ?>" required>
            </div>

            <div class="form-group">
                <label class="form-label"><?= $t['model'] ?> *</label>
                <input type="text" name="model" class="form-control" placeholder="<?= $t['model_placeholder'] ?>" required>
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="plate_number" class="form-control" placeholder="<?= $t['plate_placeholder'] ?>">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="color" class="form-control" placeholder="<?= $t['color_placeholder'] ?>" required>
            </div>
        ...
        <div class="form-row single">
            <div class="form-group">
                ...
                <textarea name="notes" class="form-control" placeholder="<?= $t['notes_placeholder'] ?>"></textarea>
            </div>
        </div>
