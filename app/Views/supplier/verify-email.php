...
$pending = $_SESSION['pending_supplier_verification'] ?? [];
$email   = $pending['email'] ?? '';
...
$attempts    = $_SESSION['supplier_verification_attempts'] ?? 0;
$maxAttempts = 5;
...
<head>
    ...
    <title><?= $fr ? 'Vérification courriel - OCSAPP Fournisseur' : 'Email Verification - OCSAPP Supplier' ?></title>
...
<body>
<?php include __DIR__ . '/../components/supplier-applicant-header.php'; ?>
...
<div class="verify-page">
    <div class="verify-card">
        ...
        <form method="POST" action="<?= url('supplier/verify-email') ?>" id="verifyForm">
            <?= csrfField() ?>
        ...
        <div class="resend-form">
            ...
            <form method="POST" action="<?= url('supplier/resend-verification') ?>" style="display:inline;">
                <?= csrfField() ?>
