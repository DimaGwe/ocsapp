...
$pending = $_SESSION['pending_user_verification'] ?? [];
$email   = $pending['email'] ?? '';
...
$badgeLabel = $fr
    ? ($role === 'seller' ? 'Portail Vendeur' : 'Portail Acheteur')
...
<head>
    ...
    <title><?= $fr ? 'Vérification courriel — OCSAPP' : 'Email Verification — OCSAPP' ?></title>
...
<div class="verify-page">
    <div class="verify-card">
        ...
        <div class="resend-form">
            ...
            <form method="POST" action="<?= url('resend-verification') ?>" style="display:inline;">
                <?= csrfField() ?>
