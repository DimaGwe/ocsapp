...
<head>
    ...
    <title>{{notification_title}} - OCSAPP</title>
</head>
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #00b207 0%, #009206 100%); padding: 40px 30px; text-align: center; border-radius: 12px 12px 0 0;">
                            ...
                            <p style="margin: 10px 0 0; color: rgba(255,255,255,0.9); font-size: 14px;">
                                Notification — Planificateur d'équipe / Team Planner Notification
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px 20px 30px;">
                                ...
                                <tr>
                                    <td style="padding: 20px; text-align: center;">
                                        <p style="margin: 0; color: #166534; font-size: 15px; font-weight: 600;">
                                            Consultez le planificateur d'équipe
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" style="width: 100%; margin-bottom: 24px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{action_url}}" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #00b207 0%, #009206 100%); color: #ffffff; text-decoration: none; border-radius: 8px; font-size: 16px; font-weight: 600; box-shadow: 0 4px 12px rgba(0, 178, 7, 0.3);">
                                            Voir dans OCSAPP
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="margin: 0; color: #9ca3af; font-size: 13px; line-height: 1.6; text-align: center;">
                                Vous pouvez gérer vos préférences de notification dans votre
                                <a href="https://ocsapp.ca/admin/profile" style="color: #00b207; text-decoration: none;">profil administrateur</a>.
                            </p>
                        </td>
                    </tr>
                        ...
                        <td style="padding: 20px 30px 40px 30px;">
                            ...
                            <table role="presentation" style="width: 100%; border-collapse: collapse; background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border-radius: 12px; margin: 24px 0; border: 2px solid #00b207;">
                                <tr>
                                    <td style="padding: 20px; text-align: center;">
                                        <p style="margin: 0; color: #166534; font-size: 15px; font-weight: 600;">
                                            Check it out in the Team Planner
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin: 0; color: #9ca3af; font-size: 13px; line-height: 1.6; text-align: center;">
                                ...
                                <a href="https://ocsapp.ca/admin/profile" style="color: #00b207; text-decoration: none;">Admin Profile</a>.
                            </p>
                        </td>
                    </tr>
