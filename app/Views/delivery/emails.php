...
function _drvDateFr(string $d, bool $fr, array $m, bool $withTime = false): string {
    $ts = strtotime($d);
    if ($fr) {
...
<div class="stats-row">
  ...
  <div class="stat-card">
    ...
    <div class="stat-value" style="font-size:16px;">
      <?= ($stats['last_email'] ?? null) ? _drvDateFr($stats['last_email'], $fr, $_frM) : '—' ?>
    </div>
  </div>
</div>
    ...
    <div class="email-item">
      <div>
        ...
        <div class="email-meta">
          <span><?= _drvDateFr($em['created_at'], $fr, $_frM, true) ?></span>
