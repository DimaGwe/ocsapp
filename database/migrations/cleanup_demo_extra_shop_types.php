<?php
/**
 * Removes everything inserted by seed_demo_extra_shop_types.php.
 * Run: php database/migrations/cleanup_demo_extra_shop_types.php
 */
...
try {
    $emails = [
        'demo-seller-bakery@ocsapp.local', 'demo-seller-butcher@ocsapp.local', 'demo-seller-pharmacy@ocsapp.local',
        'demo-seller-bookstore@ocsapp.local', 'demo-seller-hardware@ocsapp.local', 'demo-seller-boutique@ocsapp.local',
        'demo-seller-electronics@ocsapp.local',
    ];
    $slugs = [
        'demo-boulangerie-du-coin', 'demo-boucherie-artisanale', 'demo-pharmacie-sante-plus',
        'demo-librairie-des-reves', 'demo-quincaillerie-locale', 'demo-boutique-chic', 'demo-electro-plus',
    ];
    ...
    $productIds = $db->query("SELECT id FROM products WHERE slug LIKE 'demo-croissants%' OR slug LIKE 'demo-cotes-de-boeuf%' OR slug LIKE 'demo-vitamines%' OR slug LIKE 'demo-roman-best%' OR slug LIKE 'demo-ensemble-tournevis%' OR slug LIKE 'demo-robe-ete%' OR slug LIKE 'demo-chargeur%'")->fetchAll(\PDO::FETCH_COLUMN);
