...
return [
    ...
    'POST /admin/business-accounts/update-plan' => ['AdminBusinessController', 'updatePlan'],
    'POST /admin/business-accounts/credit-check' => ['AdminBusinessController', 'runCreditCheck'],
    'POST /admin/business-accounts/approve-net30' => ['AdminBusinessController', 'approveNet30'],
    'POST /admin/business-accounts/waive-credit-check' => ['AdminBusinessController', 'waiveCreditCheck'],
    ...
    'POST /distribution/card/setup-intent' => ['DistributionAuthController', 'createCardSetupIntent'],
    'POST /distribution/card/confirm' => ['DistributionAuthController', 'confirmCardSetup'],
    ...
    'GET /api/planner/meetings/comments' => ['Api\\PlannerMeetingsController', 'getComments'],
    'POST /api/planner/meetings/comments' => ['Api\\PlannerMeetingsController', 'storeComment'],
    'DELETE /api/planner/meetings/comments' => ['Api\\PlannerMeetingsController', 'deleteComment'],
